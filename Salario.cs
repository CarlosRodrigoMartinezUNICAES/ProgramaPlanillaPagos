...
namespace ProgramaPlanillaPagos
{
    public partial class Salario : Form
    {
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("Bono: $ " + Bonus, new Font("Arial", 8, FontStyle.Bold), Brushes.Blue, new Point(50, 180));
            e.Graphics.DrawString("Adelanto en salario: $ " + Advance, new Font("Arial", 8, FontStyle.Bold), Brushes.Blue, new Point(50, 180));
            e.Graphics.DrawString("Impuesto: $ " + TotTax, new Font("Arial", 8, FontStyle.Bold), Brushes.Blue, new Point(50, 180));
            e.Graphics.DrawString("Total: $ " + GrdTot, new Font("Arial", 8, FontStyle.Bold), Brushes.Blue, new Point(50, 180));
            e.Graphics.DrawString("Periodo: " + Period, new Font("Arial", 8, FontStyle.Bold), Brushes.Blue, new Point(50, 180));
        }
    }
}
